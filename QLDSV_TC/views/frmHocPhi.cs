    ...
    public partial class frmHocPhi : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void loadDataHocPhiSv()
        {
            try
            {
                ...
                this.sp_GET_HOCPHITableAdapter.Fill(this.qLDSV_TCDataSet2.SP_GET_HOCPHI, masv);
        ...
        private void loadCTDongHocPhi()
        {
            ...
            this.sP_GET_CTDONG_HOCPHITableAdapter.Fill(this.qLDSV_TCDataSet2.SP_GET_CTDONG_HOCPHI, masv, nienkhoa, int.Parse(hocky));
        ...
        private void btnGhi_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            try
            {
                ...
                this.sp_GET_HOCPHITableAdapter.Fill(this.qLDSV_TCDataSet2.SP_GET_HOCPHI, masv);
                this.sP_GET_CTDONG_HOCPHITableAdapter.Connection.ConnectionString = Program.connstr;
                this.sP_GET_CTDONG_HOCPHITableAdapter.Fill(this.qLDSV_TCDataSet2.SP_GET_CTDONG_HOCPHI, masv, nienkhoa, hocky);
        ...
        private void gridView2_ValidateRow(object sender, DevExpress.XtraGrid.Views.Base.ValidateRowEventArgs e)
        {
            ...
            else
            {
                ...
                {
                    this.sP_GET_CTDONG_HOCPHITableAdapter.Connection.ConnectionString = Program.connstr;
                    this.sP_GET_CTDONG_HOCPHITableAdapter.Fill(this.qLDSV_TCDataSet2.SP_GET_CTDONG_HOCPHI, masv, txtNienKhoa.Text, int.Parse(txtHocKy.Text));
                    if (bds_SP_GET_CTDONG_HOCPHI.Count == 0)
                        btnSua.Enabled = barBtnXoa.Enabled = true;
                    panelNhapHocPhi.Enabled = false;
                    btnThem.Enabled = true;
